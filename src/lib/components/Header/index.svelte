	...
	<nav>
		...
		{#if menuOpen}
			<ul transition:slide|local={{ duration: 300, easing: quintOut }}>
				...
				<li>
					<a
						class:active={$page.path === '/character-concepts'}
						sveltekit:prefetch
						href="/character-concepts">Character Concepts</a
					>
				</li>
				<li>
					<a
						class:active={$page.path === '/graphic-design'}
						sveltekit:prefetch
						href="/graphic-design">Graphic Design</a
					>
				</li>
				<li>
					<a class:active={$page.path === '/projects'} sveltekit:prefetch href="/projects"
						>Projects</a
					>
				</li>
				<li>
					<a rel="external" target="_blank" href="https://jonelliottart.storenvy.com/">Store</a>
				</li>
				<li>
